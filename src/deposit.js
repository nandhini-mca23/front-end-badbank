...
//     <Card className='card' border="success" style={{ width: '34rem',height:'25rem' }}>
    ...
    async function handleClick(e){
        ...
        for(let i=0;i<data.length;i++){
            ...
            if(data[i].name === name && data[i].password === pass){
                ...
                await axios.put(`https://server-1-tq16.onrender.com/update/${data[i]._id}`,{amount:data[i].amount  + Number(deposit)});
